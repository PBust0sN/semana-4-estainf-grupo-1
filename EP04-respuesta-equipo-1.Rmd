...
A partir de los resultados podemos ver que entre la estrategia 1 en relación con las estrategias 1 y 2, entonces podemos ver que con un p-value de << 0 podemos decir que la acptación no es igual, pero en relación con la aceptacion de la 2 en relación a la 3, esta si es igual, por lo que recomendamos volver a repetir el experimento pero con más datos
