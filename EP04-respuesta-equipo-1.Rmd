...
nombres = c("estrategia_1", "estrategia_2", "estrategia_3")

df_valores <- as.data.frame(datos_aleatorios[, 1:3])
datos1 <- cbind(Nombres = nombres, df_valores)


datos_aleatorios <- data.frame(instancias)

# llevamos los datos a formalo largo
datos_largos <- datos_aleatorios |> pivot_longer(c("estrategia_1", "estrategia_2", "estrategia_3"),
...
print(matriz)
prueba <- mcnemar.test(matriz, correct = T)
print(prueba)
```
